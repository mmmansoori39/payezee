...
import { depositStatus } from "../utils/constants/constants.js";
...
const depositMasterSchema = Schema(
  {
    sequence: {
      type: Number,
      required: true
...
depositMasterSchema.pre("save", async function (next) {
  if (this.isNew) {
 ...
 * @typedef Store
 */
const DepositMaster = model("DepositMaster", depositMasterSchema, "depositmaster");
